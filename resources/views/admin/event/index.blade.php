                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <a href="javascript:;" class="btn btn-sm btn-success" data-toggle="modal" data-target="#myModal">Add new Event</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                            ...
                                            <tbody>
                                                @foreach ($events as $index=>$event)
                                                    <tr class="odd gradeX">
                                                        ...
                                                        <td>{{$event->time}}</td>
                                                        <td>{{$event->date}}</td>
                                                        <td>{{$event->contact_phone}}<br>{{$event->contact_email}}</td>
                                                        <td>{{($event->status == 1) ? 'Active' : 'Inactive'}}</td>
                                                        <td class="center">
                                                            <a href="{{route('manage-event.show',$event)}}" class="btn btn-sm btn-info">Details</a>
                                                            <a href="{{route('manage-event.edit',$event)}}" class="btn btn-sm btn-warning">Edit</a>
                                                            <a href="{{route('manage-event.delete',$event)}}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
