...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
        <a href="{{route('teacher.home')}}" class="d-block">{{auth()->user()->name}}</a>
        </div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('teacher.add-course-material')}}" class="nav-link">
              <i class="nav-icon fas fa-tachometer-alt"></i>
              <p>
                Add Course Material
              </p>
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline-block">
        <img style="height: 50px;width:170px;margin-top:0;padding-bottom: 10px" src="{{asset('home/images/_logo_v.png')}}" alt="">
    </div>
  </footer>
